...
foreach ($file in @('work.mjs','work-mcp.mjs','project-context.mjs','work-task.mjs','work-plan.mjs','work-route.mjs','work-exec.mjs','work-sandbox.mjs','work-patch.mjs')) { Copy-Item (Join-Path $Root "scripts/$file") (Join-Path $InstallDir $file) -Force }
