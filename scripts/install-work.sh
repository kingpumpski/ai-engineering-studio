...
for f in work.mjs work-mcp.mjs project-context.mjs work-task.mjs work-plan.mjs work-route.mjs work-exec.mjs work-sandbox.mjs work-patch.mjs work-verify.mjs work-diagnose.mjs work-github.mjs work-ci.mjs work-memory.mjs work-knowledge.mjs; do cp "${ROOT}/scripts/${f}" "${INSTALL_DIR}/${f}"; done
